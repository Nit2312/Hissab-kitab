    ...
    <section className="relative overflow-hidden py-20 md:py-32">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          <Badge variant="secondary" className="mb-6 rounded-full border border-border/60 bg-card/80 px-4 py-1.5 shadow-sm">
            Trusted by 10,000+ users
          </Badge>
          
          <h1 className="mb-6 text-balance text-4xl font-semibold tracking-tight text-foreground md:text-6xl">
            Split expenses, track udhaar, and settle up without the mess.
          </h1>
          
          <p className="mx-auto mb-10 max-w-2xl text-pretty text-lg leading-8 text-muted-foreground md:text-xl">
            The simple way to manage shared expenses with friends and family, or track credit for your small business. Built for Indian workflows and everyday use.
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div className="flex flex-col items-center gap-2 rounded-2xl border border-border/60 bg-card/80 p-6 shadow-sm backdrop-blur">
